"""
This example loads the pre-trained SentenceTransformer model 'msmarco-MiniLM-L6-cos-v5' from the server.
...
if __name__ == "__main__":
    # retrieve inputs
    model_save_path = f"../finsearch_embedder/models/finmsmarco"
