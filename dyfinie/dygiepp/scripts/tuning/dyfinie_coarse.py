...
def objective(trial: optuna.Trial) -> float:
    ...
    executor = optuna.integration.allennlp.AllenNLPExecutor(
        ...
        config_file="./training_config/dyfinie_coarse.jsonnet",  # jsonnet path
        serialization_dir=f"./result/dyfinie_coarse/{trial.number}",  # directory for snapshots and logs
