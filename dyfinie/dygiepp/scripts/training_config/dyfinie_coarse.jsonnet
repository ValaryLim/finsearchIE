...
template.DyGIE {
    ...
    cuda_device: -1,
    data_paths: {
        train: "data/dyfinie_coarse/normalized_data/train.json",
        validation: "data/dyfinie_coarse/normalized_data/dev.json",
        test: "data/dyfinie_coarse/normalized_data/test.json",
    },
    loss_weights: {
        ner: 0.2,
        relation: 1.0,
